...
if __name__ == '__main__':
    config = load_config('config/GAN_G1_D2_ConvDesc.yaml')
    ...
    GAN_Model.Generator.load_state_dict(torch.load('./weights/GAN_G1_D2_ConvDesc/Generator/Generator_377.pth'))
    GAN_Model.eval()
